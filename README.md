...
4. 왼쪽 상단의 Menu 버튼을 누르면 메뉴와 함께 옵션이 나타납니다.
...
|구분 |측정 구간                                                                |평균 소요 시간 |
|-----|-------------------------------------------------------------------------|--------------:|
|CPU  |프레임 시간                                                              |475,557 ns     |
|     |├─논-렌더 로직                                                           |3,276 ns       |
|     |└─ 렌더 로직                                                             |472,159 ns     |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ 커맨드 리스트 초기화  |125,833 ns     |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ 자원 바인딩           |10,332 ns      |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ 씬 그리기             |3,637 ns       |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ GUI 그리기            |12,885 ns      |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ 자원 언바인딩         |1,652 ns       |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ 커맨드 리스트 제출    |75,906 ns      |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└─ 제시                  |240,864 ns     |
|GPU  |프레임 시간                                                              |34,825 ns      |
|     |├─ 자원 바인딩                                                           |29,285 ns      |
|     |├─ 씬 그리기                                                             |5,336 ns       |
|     |├─ GUI 그리기                                                            |143 ns         |
|     |└─ 자원 언바인딩                                                         |11 ns          |

- 총 캡처 시간: 12,050.07 ms

- GPU 명령이 모두 소진될 때까지 CPU를 대기시키는 현 로직으로 인해, 커맨드 리스트 초기화 과정에서 CPU 프레임 시간의 약 25%가 대기 상태로 낭비되고 있습니다.

- 두 개의 정육면체를 그리는 과정이 포함되며 씬 그리기의 CPU 소요 시간은 기존 646 ns에서 현재 3,637 ns으로 증가하였고, 씬 그리기의 GPU 소요 시간은 기존 9 ns에서 5,336 ns로 크게 증가하였으나, 여전히 GPU의 연산 대부분은 백 버퍼의 색상을 초기화하는 로직이 포함된 자원 바인딩 구간에서 발생하고 있습니다.
...
|구분 |측정 구간                                                                |평균 소요 시간 |
|-----|-------------------------------------------------------------------------|--------------:|
|CPU  |프레임 시간                                                              |4,167,823 ns   |
|     |├─논-렌더 로직                                                           |5,463 ns       |
|     |└─ 렌더 로직                                                             |4,162,122 ns   |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ 커맨드 리스트 초기화  |3,641,106 ns   |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ 자원 바인딩           |22,463 ns      |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ 씬 그리기             |7,303 ns       |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ GUI 그리기            |25,368 ns      |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ 자원 언바인딩         |2,749 ns       |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├─ 커맨드 리스트 제출    |127,533 ns     |
|     |&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└─ 제시                  |333,708 ns     |
|GPU  |프레임 시간                                                              |298,589 ns     |
|     |├─ 자원 바인딩                                                           |260,424 ns     |
|     |├─ 씬 그리기                                                             |37,470 ns      |
|     |├─ GUI 그리기                                                            |612 ns         |
|     |└─ 자원 언바인딩                                                         |16 ns          |

- 총 캡처 시간: 11,497.53 ms
